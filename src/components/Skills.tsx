...
import { Pickaxe , Code } from 'lucide-react';
...
export function Skills({ skills, revealedSkills, onReveal }: SkillsProps) {
  return (
    <section id="skills" className="min-h-screen bg-slate-800 px-4 sm:px-8 md:px-16 py-16 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold mb-12 text-purple-500 flex items-center gap-3">Skills
        <Code className="w-8 h-8 animate-float" />
        </h2>
